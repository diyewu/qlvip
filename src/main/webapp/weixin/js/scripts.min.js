if (function(t, e) {
		...
		function r(t) {
			var e = {};
			return ht.each(t.match(kt) || [], function(t, n) {
					e[n] = !0
				}), e
		}
		function s() {
		...
		function a() {
			(nt.addEventListener || "load" === t.event.type || "complete" === nt.readyState) && (s(), ht.ready())
		}
		function l(t, e, n) {
		...
		function u(t, e, n, i) {
			if (At(t)) {
				var o,
					...
					l = a ? ht.cache : t,
					c = a ? t[s] : t[s] && s;
				if (c && l[c] && (i || l[c].data) || void 0 !== n || "string" != typeof e) return c || (c = a ? t[s] = et.pop() || ht.guid++ : s), l[c] || (l[c] = a ? {} : {
							toJSON : ht.noop
						}), "object" != typeof e && "function" != typeof e || (i ? l[c] = ht.extend(l[c], e) : l[c].data = ht.extend(l[c].data, e)), r = l[c], i || (r.data || (r.data = {}), r = r.data), void 0 !== n && (r[ht.camelCase(e)] = n), "string" == typeof e ? null == (o = r[e]) && (o = r[ht.camelCase(e)]) : o = r, o
			}
		}
		function d(t, e, n) {
			if (At(t)) {
				...
				if (s[a]) {
					...
					(n || (
					delete s[a].data
					, c(s[a]))) && (r ? ht.cleanData([ t ], !0) : ut.deleteExpando || s != s.window ?
						delete s[a]
						: s[a] = void 0)
				}
			}
		...
		function v(t, e, n, i, o) {
			for (var r, s, a, l, c, u, d, h = t.length, v = p(e), y = [], w = 0; h > w; w++)
				if ((s = t[w]) || 0 === s)
					if ("object" === ht.type(s)) ht.merge(y, s.nodeType ? [ s ] : s);
						...
						for (l = l || v.appendChild(e.createElement("div")), c = (Ht.exec(s) || [ "", "" ])[1].toLowerCase(), d = Ft[c] || Ft._default, l.innerHTML = d[1] + ht.htmlPrefilter(s) + d[2], r = d[0]; r--;) l = l.lastChild;
						if (!ut.leadingWhitespace && Rt.test(s) && y.push(e.createTextNode(Rt.exec(s)[0])), !ut.tbody)
			...
			for (l && v.removeChild(l), ut.appendChecked || ht.grep(f(y, "input"), m), w = 0; s = y[w++];)
				...
				else if (a = ht.contains(s.ownerDocument, s), l = f(v.appendChild(s), "script"), a && g(l), n)
					for (r = 0; s = l[r++];) Wt.test(s.type || "") && n.push(s);
			return l = null, v
		}
		function y() {
			return !0
		...
		function _(t, e) {
			if (1 === e.nodeType && ht.hasData(t)) {
				...
				if (a) {
					...
					, s.events = {};
					for (n in a)
						for (i = 0, o = a[n].length; o > i; i++) ht.event.add(e, n, a[n][i])
				}
		...
		function E(t, e) {
			var n,
				...
				o;
			if (1 === e.nodeType) {
				if (n = e.nodeName.toLowerCase(), !ut.noCloneEvent && e[ht.expando]) {
					o = ht._data(e);
					for (i in o.events) ht.removeEvent(e, i, o.handle);
					e.removeAttribute(ht.expando)
				}
				"script" === n && e.text !== t.text ? (T(e).text = t.text, S(e)) : "object" === n ? (e.parentNode && (e.outerHTML = t.outerHTML), ut.html5Clone && t.innerHTML && !ht.trim(e.innerHTML) && (e.innerHTML = t.innerHTML)) : "input" === n && zt.test(t.type) ? (e.defaultChecked = e.checked = t.checked, e.value !== t.value && (e.value = t.value)) : "option" === n ? e.defaultSelected = e.selected = t.defaultSelected : "input" !== n && "textarea" !== n || (e.defaultValue = t.defaultValue)
			}
		}
		function k(t, e, n, i) {
			e = ot.apply([], e);var o,
			...
			if (g || d > 1 && "string" == typeof p && !ut.checkClone && ee.test(p)) return t.each(function(o) {
					var r = t.eq(o);
					g && (e[0] = p.call(this, o, r.html())), k(r, e, n, i)
				});
			if (d && (c = v(e, t[0].ownerDocument, !1, t, i), o = c.firstChild, 1 === c.childNodes.length && (c = o), o || i)) {
				for (s = (a = ht.map(f(c, "script"), T)).length; d > u; u++) r = c, u !== h && (r = ht.clone(r, !0, !0), s && ht.merge(a, f(r, "script"))), n.call(t[u], r, u);
				if (s)
					for (l = a[a.length - 1].ownerDocument, ht.map(a, S), u = 0; s > u; u++) r = a[u], Wt.test(r.type || "") && !ht._data(r, "globalEval") && ht.contains(l, r) && (r.src ? ht._evalUrl && ht._evalUrl(r.src) : ht.globalEval((r.text || r.textContent || r.innerHTML || "").replace(ie, "")));
				c = o = null
			}
			return t
		}
		function $(t, e, n) {
			for (var i, o = e ? ht.filter(e, t) : t, r = 0; null != (i = o[r]); r++) n || 1 !== i.nodeType || ht.cleanData(f(i)), i.parentNode && (n && ht.contains(i.ownerDocument, i) && g(f(i, "script")), i.parentNode.removeChild(i));
			return t
		}
		function N(t, e) {
		...
		function A(t) {
			var e = nt,
				n = se[t];
			return n || ("none" !== (n = N(t, e)) && n || (re = (re || ht("<iframe frameborder='0' width='0' height='0'/>")).appendTo(e.documentElement), (e = (re[0].contentWindow || re[0].contentDocument).document).write(), e.close(), n = N(t, e), re.detach()), se[t] = n), n
		}
		function I(t, e) {
			return {
				get : function() {
		...
		function D(t, e) {
			for (var n, i, o, r = [], s = 0, a = t.length; a > s; s++) (i = t[s]).style && (r[s] = ht._data(i, "olddisplay"), n = i.style.display, e ? (r[s] || "none" !== n || (i.style.display = ""), "" === i.style.display && Mt(i) && (r[s] = ht._data(i, "olddisplay", A(i.nodeName)))) : (o = Mt(i), (n && "none" !== n || !o) && ht._data(i, "olddisplay", o ? n : ht.css(i, "display"))));
		...
		function L(t, e, n, i, o) {
			for (var r = n === (i ? "border" : "content") ? 4 : "width" === e ? 1 : 0, s = 0; 4 > r; r += 2) "margin" === n && (s += ht.css(t, n + Lt[r], !0, o)), i ? ("content" === n && (s -= ht.css(t, "padding" + Lt[r], !0, o)), "margin" !== n && (s -= ht.css(t, "border" + Lt[r] + "Width", !0, o))) : (s += ht.css(t, "padding" + Lt[r], !0, o), "padding" !== n && (s += ht.css(t, "border" + Lt[r] + "Width", !0, o)));
			return s
		}
		function M(t, e, n) {
			var i = !0,
			...
			if (0 >= o || null == o) {
				...
				i = s && (ut.boxSizingReliable() || o === t.style[e]), o = parseFloat(o) || 0
			}
		...
		function W(t, e, n) {
			for (var i, o = (q.tweeners[e] || []).concat(q.tweeners["*"]), r = 0, s = o.length; s > r; r++)
		...
		function R(t, e) {
			var n,
				...
				s;
			for (n in t)
				if (i = ht.camelCase(n), o = e[i], r = t[n], ht.isArray(r) && (o = r[1], r = t[n] = r[0]), n !== i && (t[i] = r,
					delete t[n]
		...
		function q(t, e, n) {
			var i,
				...
				l = function() {
					if (o) return !1;
					for (var e = Ce || z(), n = Math.max(0, c.startTime + c.duration - e), i = 1 - (n / c.duration || 0), r = 0, s = c.tweens.length; s > r; r++) c.tweens[r].run(i);
			...
			for (R(u, c.opts.specialEasing); s > r; r++)
				if (i = q.prefilters[r].call(c, t, u, c.opts)) return ht.isFunction(i.stop) && (ht._queueHooks(c.elem, c.opts.queue).stop = ht.proxy(i.stop, i)), i;
		...
		function G(t) {
			if (!ht.contains(t.ownerDocument || nt, t)) return !0;
			for (; t && 1 === t.nodeType;) {
		...
		function Z(t, e, n, i) {
			...
			if (ht.isArray(e)) ht.each(e, function(e, o) {
					n || tn.test(t) ? i(t, o) : Z(t + "[" + ("object" == typeof o && null != o ? e : "") + "]", o, n, i)
				});
			else if (n || "object" !== ht.type(e)) i(t, e);else
		...
		ht.fn = ht.prototype = {
			...
			makeArray : function(t, e) {
				var i = e || [];
				return null != t && (n(Object(t)) ? ht.merge(i, "string" == typeof t ? [ t ] : t) : rt.call(i, t)), i
			},
			...
			proxy : function(t, e) {
				var n,
					i,
					o;
				return "string" == typeof e && (o = t[e], e = t, t = o), ht.isFunction(t) ? (n = it.call(arguments, 2), i = function() {
						return t.apply(e || this, n.concat(it.call(arguments)))
					}, i.guid = t.guid = t.guid || ht.guid++, i) : void 0
			},
			now : function() {
				return +new Date
			},
		...
		var vt = function(t) {
			function e(t, e, n, i) {
				...
				if (!i && ((e ? e.ownerDocument || e : z) !== A && N(e), e = e || A, O)) {
					if (11 !== g && (d = gt.exec(t)))
						if (o = d[1]) {
							if (9 === g) {
							...
							if (d[2]) return G.apply(n, e.getElementsByTagName(t)), n;
							if ((o = d[3]) && w.getElementsByClassName && e.getElementsByClassName) return G.apply(n, e.getElementsByClassName(o)), n
					}
					if (w.qsa && !F[t + " "] && (!D || !D.test(t))) {
						if (1 !== g) f = e, p = t;
				...
				return _(t.replace(rt, "$1"), e, n, i)
			}
			function n() {
				function t(n, i) {
					return e.push(n + " ") > b.cacheLength &&
						delete t[e.shift()]
						, t[n + " "] = i
				}
				var e = [];
			...
			function d(t, e, n) {
				...
				return e.first ? function(e, n, r) {
					...
					if (s) {
						...
						for (; e = e[i];)
							if (1 === e.nodeType || o) {
								if (c = e[j] || (e[j] = {}), l = c[e.uniqueID] || (c[e.uniqueID] = {}), (a = l[i]) && a[0] === H && a[1] === r) return u[2] = a[2];
			...
			function g(t, e, n, o, r, s) {
				return o && !o[j] && (o = g(o)), r && !r[j] && (r = g(r, s)), i(function(i, s, a, l) {
						var c,
							u,
							d,
							h = [],
						...
						if (i) {
							if (r || t) {
								...
								for (u = w.length; u--;) (d = w[u]) && (c = r ? K(i, d) : h[u]) > -1 && (i[c] = !(s[c] = d))
							}
						} else w = f(w === s ? w.splice(m, w.length) : w), r ? r(null, s, w, l) : G.apply(s, w)
					})
			}
			function m(t) {
				for (var e, n, i, o = t.length, r = b.relative[t[0].type], s = r || b.relative[" "], a = r ? 1 : 0, l = d(function(t) {
							return t === e
						}, s, !0), c = d(function(t) {
							return K(e, t) > -1
					...
					if (n = b.relative[t[a].type])
						...
						if ((n = b.filter[t[a].type].apply(null, t[a].matches))[j]) {
							for (i = ++a; o > i && !b.relative[t[i].type]; i++)
								;
							return g(a > 1 && h(p), a > 1 && u(t.slice(0, a - 1).concat({
									value : " " === t[a - 2].type ? "*" : ""
								})).replace(rt, "$1"), n, i > a && m(t.slice(a, i)), o > i && m(t = t.slice(i)), o > i && u(t))
						}
						p.push(n)
				}
				return h(p)
			...
			try {
				...
				return i !== A && 9 === i.nodeType && i.documentElement ? (A = i, I = A.documentElement, O = !C(A), (n = A.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", bt, !1) : n.attachEvent && n.attachEvent("onunload", bt)), w.attributes = o(function(t) {
				...
				}, P = [], D = [], (w.qsa = ft.test(A.querySelectorAll)) && (o(function(t) {
				...
				}), D = D.length && new RegExp(D.join("|")), P = P.length && new RegExp(P.join("|")), e = ft.test(I.compareDocumentPosition), M = e || ft.test(I.contains) ? function(t, e) {
					...
					return n || (1 & (n = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1) || !w.sortDetached && e.compareDocumentPosition(t) === n ? t === A || t.ownerDocument === z && M(z, t) ? -1 : e === A || e.ownerDocument === z && M(z, e) ? 1 : k ? K(k, t) - K(k, e) : 0 : 4 & n ? -1 : 1)
				} : function(t, e) {
					if (t === e) return $ = !0, 0;
					var n,
						i = 0,
				...
				if ((t.ownerDocument || t) !== A && N(t), n = n.replace(lt, "='$1']"), w.matchesSelector && O && !F[n + " "] && (!P || !P.test(n)) && (!D || !D.test(n))) try {
						var i = L.call(t, n);
						if (i || w.disconnectedMatch || t.document && 11 !== t.document.nodeType) return i
					} catch (t) {} return e(n, A, null, [ t ]).length > 0
			}, e.contains = function(t, e) {
				return (t.ownerDocument || t) !== A && N(t), M(t, e)
			}, e.attr = function(t, e) {
				(t.ownerDocument || t) !== A && N(t);
				var n = b.attrHandle[e.toLowerCase()],
					i = n && X.call(b.attrHandle, e.toLowerCase()) ? n(t, e, !O) : void 0;
				...
				filter : {
						...
						return 1 === i && 0 === o ? function(t) {
							...
							if (m) {
								...
								if (f = [ s ? m.firstChild : m.lastChild ], s && y) {
									...
									for (; (h = ++p && h && h[g] || (w = p = 0) || f.pop()) && ((a ? h.nodeName.toLowerCase() !== v : 1 !== h.nodeType) || !++w || (y && (d = h[j] || (h[j] = {}), u = d[h.uniqueID] || (d[h.uniqueID] = {}), u[t] = [ H, w ]), h !== e));)
										;
					...
					PSEUDO : function(t, n) {
						var o,
							r = b.pseudos[t] || b.setFilters[t.toLowerCase()] || e.error("unsupported pseudo: " + t);
						return r[j] ? r(n) : r.length > 1 ? (o = [ t, t, "", n ], b.setFilters.hasOwnProperty(t.toLowerCase()) ? i(function(t, e) {
			...
			return c.prototype = b.filters = b.pseudos, b.setFilters = new c, T = e.tokenize = function(t, n) {
					...
					for (a = t, l = [], c = b.preFilter; a;) {
						...
						for (s in b.filter) !(o = dt[s].exec(a)) || c[s] && !(o = c[s](o)) || (i = o.shift(), r.push({
								value : i,
								type : s,
								matches : o
							}), a = a.slice(i.length));
					...
					var n,
						...
						r = F[t + " "];
					if (!r) {
						for (e || (e = T(t)), n = e.length; n--;) (r = m(e[n]))[j] ? i.push(r) : o.push(r);
						(r = F(t, v(o, i))).selector = t
					}
					return r
		...
		ht.filter = function(t, e, n) {
			...
			is : function(t) {
				return !!i(this, "string" == typeof t && bt.test(t) ? ht(t) : t || [], !1).length
			}
		});
		var Tt,
			St = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/;
		(ht.fn.init = function(t, e, n) {
			...
			if (n = n || Tt, "string" == typeof t) {
				...
				if (i[1]) {
					if (e = e instanceof ht ? e[0] : e, ht.merge(this, ht.parseHTML(i[1], e && e.nodeType ? e.ownerDocument || e : nt, !0)), xt.test(i[1]) && ht.isPlainObject(e))
			...
			return t.nodeType ? (this.context = this[0] = t, this.length = 1, this) : ht.isFunction(t) ? void 0 !== n.ready ? n.ready(t) : t(ht) : (void 0 !== t.selector && (this.selector = t.selector, this.context = t.context), ht.makeArray(t, this))
		}).prototype = ht.fn, Tt = ht(nt);
		...
		ht.fn.extend({
			...
			closest : function(t, e) {
				for (var n, i = 0, o = this.length, r = [], s = bt.test(t) || "string" != typeof t ? ht(t, e || this.context) : 0; o > i; i++)
			...
			ht.fn[t] = function(n, i) {
				...
				return "Until" !== t.slice(-5) && (i = n), i && "string" == typeof i && (o = ht.filter(i, o)), this.length > 1 && (Et[t] || (o = ht.uniqueSort(o)), _t.test(t) && (o = o.reverse())), this.pushStack(o)
			}
		});
		var kt = /\S+/g;
		ht.Callbacks = function(t) {
				...
				u = {
					...
					remove : function() {
						return ht.each(arguments, function(t, e) {
								for (var n; (n = ht.inArray(e, s, n)) > -1;) s.splice(n, 1), l >= n && l--
							}), this
					},
					has : function(t) {
			...
			when : function(t) {
				var e,
					...
					c = function(t, n, i) {
						return function(o) {
							n[t] = this, i[t] = arguments.length > 1 ? it.call(arguments) : o, i === e ? l.notifyWith(n, i) : --a || l.resolveWith(n, i)
						}
					};
				if (s > 1)
					for (e = new Array(s), n = new Array(s), i = new Array(s); s > o; o++) r[o] && ht.isFunction(r[o].promise) ? r[o].promise().progress(c(o, n, e)).done(c(o, i, r)).fail(l.reject) : --a;
		...
		ht.fn.ready = function(t) {
			...
			ready : function(t) {
				(!0 === t ? --ht.readyWait : ht.isReady) || (ht.isReady = !0, !0 !== t && --ht.readyWait > 0 || ($t.resolveWith(nt, [ ht ]), ht.fn.triggerHandler && (ht(nt).triggerHandler("ready"), ht(nt).off("ready"))))
			}
		}), ht.ready.promise = function(e) {
			if (!$t)
				if ($t = ht.Deferred(), "complete" === nt.readyState || "loading" !== nt.readyState && !nt.documentElement.doScroll) t.setTimeout(ht.ready);
				else if (nt.addEventListener) nt.addEventListener("DOMContentLoaded", a), t.addEventListener("load", a);else {
					nt.attachEvent("onreadystatechange", a), t.attachEvent("onload", a);
					var n = !1;
					try {
						n = null == t.frameElement && nt.documentElement
					} catch (t) {} n && n.doScroll && function e() {
						if (!ht.isReady) {
							try {
								n.doScroll("left")
							} catch (n) {
		...
		ht.extend({
			...
			data : function(t, e) {
				...
				if (void 0 === t) {
					if (this.length && (o = ht.data(r), 1 === r.nodeType && !ht._data(r, "parsedAttrs"))) {
						for (n = s.length; n--;) s[n] && 0 === (i = s[n].name).indexOf("data-") && (i = ht.camelCase(i.slice(5)), l(r, i, o[i]));
			...
			queue : function(t, e, n) {
				var i;
				return t ? (e = (e || "fx") + "queue", i = ht._data(t, e), n && (!i || ht.isArray(n) ? i = ht._data(t, e, ht.makeArray(n)) : i.push(n)), i || []) : void 0
			},
			...
			promise : function(t, e) {
				...
				for ("string" != typeof t && (e = t, t = void 0), t = t || "fx"; s--;) (n = ht._data(r[s], t + "queueHooks")) && n.empty && (i++, n.empty.add(a));
		...
		!function() {
			...
			for (e in {submit : !0, change : !0, focusin : !0}) n = "on" + e, (ut[e] = n in t) || (i.setAttribute(n, "t"), ut[e] = !1 === i.attributes[n].expando);
			i = null
		}();
		...
		ht.event = {
			...
			add : function(t, e, n, i, o) {
				var r,
					...
					m = ht._data(t);
				if (m) {
					for (n.handler && (l = n, n = l.handler, o = l.selector), n.guid || (n.guid = ht.guid++), (s = m.events) || (s = m.events = {}), (u = m.handle) || (u = m.handle = function(t) {
							...
							namespace : f.join(".")
						}, l), (h = s[p]) || (h = s[p] = [], h.delegateCount = 0, c.setup && !1 !== c.setup.call(t, i, f, u) || (t.addEventListener ? t.addEventListener(p, u, !1) : t.attachEvent && t.attachEvent("on" + p, u))), c.add && (c.add.call(t, d), d.handler.guid || (d.handler.guid = n.guid)), o ? h.splice(h.delegateCount++, 0, d) : h.push(d), ht.event.global[p] = !0);
					t = null
				}
			},
				...
				if (m && (u = m.events)) {
					for (c = (e = (e || "").match(kt) || [ "" ]).length; c--;)
						if (a = Gt.exec(e[c]) || [], p = g = a[1], f = (a[2] || "").split(".").sort(), p) {
							for (d = ht.event.special[p] || {}, h = u[p = (i ? d.delegateType : d.bindType) || p] || [], a = a[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), l = r = h.length; r--;) s = h[r], !o && g !== s.origType || n && n.guid !== s.guid || a && !a.test(s.namespace) || i && i !== s.selector && ("**" !== i || !s.selector) || (h.splice(r, 1), s.selector && h.delegateCount--, d.remove && d.remove.call(t, s));
							l && !h.length && (d.teardown && !1 !== d.teardown.call(t, f, m.handle) || ht.removeEvent(t, p, m.handle),
							delete u[p]
							)
						} else
							for (p in u) ht.event.remove(t, p + e[c], n, i, !0);
					ht.isEmptyObject(u) && (
					delete m.handle
			...
			trigger : function(e, n, i, o) {
				...
				if (a = u = i = i || nt, 3 !== i.nodeType && 8 !== i.nodeType && !Yt.test(p + ht.event.triggered) && (p.indexOf(".") > -1 && (f = p.split("."), p = f.shift(), f.sort()), s = p.indexOf(":") < 0 && "on" + p, e = e[ht.expando] ? e : new ht.Event(p, "object" == typeof e && e), e.isTrigger = o ? 2 : 3, e.namespace = f.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = i), n = null == n ? [ e ] : ht.makeArray(n, [ e ]), c = ht.event.special[p] || {}, o || !c.trigger || !1 !== c.trigger.apply(i, n))) {
					if (!o && !c.noBubble && !ht.isWindow(i)) {
						for (l = c.delegateType || p, Yt.test(l + p) || (a = a.parentNode); a; a = a.parentNode) h.push(a), u = a;
						u === (i.ownerDocument || nt) && h.push(u.defaultView || u.parentWindow || t)
					}
					for (d = 0; (a = h[d++]) && !e.isPropagationStopped();) e.type = d > 1 ? l : c.bindType || p, (r = (ht._data(a, "events") || {})[e.type] && ht._data(a, "handle")) && r.apply(a, n), (r = s && a[s]) && r.apply && At(a) && (e.result = r.apply(a, n), !1 === e.result && e.preventDefault());
					if (e.type = p, !o && !e.isDefaultPrevented() && (!c._default || !1 === c._default.apply(h.pop(), n)) && At(i) && s && i[p] && !ht.isWindow(i)) {
						(u = i[s]) && (i[s] = null), ht.event.triggered = p;try {
							i[p]()
						} catch (t) {} ht.event.triggered = void 0, u && (i[s] = u)
					}
					return e.result
				}
			},
			dispatch : function(t) {
				...
				if (a[0] = t, t.delegateTarget = this, !c.preDispatch || !1 !== c.preDispatch.call(this, t)) {
					for (s = ht.event.handlers.call(this, t, l), e = 0; (o = s[e++]) && !t.isPropagationStopped();)
						for (t.currentTarget = o.elem, n = 0; (r = o.handlers[n++]) && !t.isImmediatePropagationStopped();) t.rnamespace && !t.rnamespace.test(r.namespace) || (t.handleObj = r, t.data = r.data, void 0 !== (i = ((ht.event.special[r.origType] || {}).handle || r.handler).apply(o.elem, a)) && !1 === (t.result = i) && (t.preventDefault(), t.stopPropagation()));
				...
				if (a && l.nodeType && ("click" !== t.type || isNaN(t.button) || t.button < 1))
					for (; l != this; l = l.parentNode || this)
						if (1 === l.nodeType && (!0 !== l.disabled || "click" !== t.type)) {
							for (i = [], n = 0; a > n; n++) r = e[n], o = r.selector + " ", void 0 === i[o] && (i[o] = r.needsContext ? ht(o, this).index(l) > -1 : ht.find(o, this, null, [ l ]).length), i[o] && i.push(r);
							i.length && s.push({
								elem : l,
								handlers : i
							})
			...
			fix : function(t) {
				...
				var e,
					...
					r = t,
					s = this.fixHooks[o];
				for (s || (this.fixHooks[o] = s = Vt.test(o) ? this.mouseHooks : Qt.test(o) ? this.keyHooks : {}), i = s.props ? this.props.concat(s.props) : this.props, t = new ht.Event(r), e = i.length; e--;) n = i[e], t[n] = r[n];
		...
		}, ht.removeEvent = nt.removeEventListener ? function(t, e, n) {
		...
		ht.extend({
			...
			clone : function(t, e, n) {
				...
				if (ut.html5Clone || ht.isXMLDoc(t) || !Kt.test("<" + t.nodeName + ">") ? r = t.cloneNode(!0) : (oe.innerHTML = t.outerHTML, oe.removeChild(r = oe.firstChild)), !(ut.noCloneEvent && ut.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || ht.isXMLDoc(t)))
					for (i = f(r), a = f(t), s = 0; null != (o = a[s]); ++s) i[s] && E(o, i[s]);
				if (e)
					if (n)
						for (a = a || f(t), i = i || f(r), s = 0; null != (o = a[s]); s++) _(o, i[s]);
					else _(t, r);
				return (i = f(r, "script")).length > 0 && g(i, !l && f(t, "script")), i = a = o = null, r
			},
			cleanData : function(t, e) {
				for (var n, i, o, r, s = 0, a = ht.expando, l = ht.cache, c = ut.attributes, u = ht.event.special; null != (n = t[s]); s++)
					if ((e || At(n)) && (o = n[a], r = o && l[o])) {
						if (r.events)
							for (i in r.events) u[i] ? ht.event.remove(n, i) : ht.removeEvent(n, i, r.handle);
						l[o] && (
						delete l[o]
						, c || void 0 === n.removeAttribute ? n[a] = void 0 : n.removeAttribute(a), et.push(o))
				}
			}
		}), ht.fn.extend({
			domManip : k,
			...
			text : function(t) {
				return jt(this, function(t) {
					return void 0 === t ? ht.text(this) : this.empty().append((this[0] && this[0].ownerDocument || nt).createTextNode(t))
			...
			html : function(t) {
				return jt(this, function(t) {
					...
					if ("string" == typeof t && !te.test(t) && (ut.htmlSerialize || !Kt.test(t)) && (ut.leadingWhitespace || !Rt.test(t)) && !Ft[(Ht.exec(t) || [ "", "" ])[1].toLowerCase()]) {
						t = ht.htmlPrefilter(t);try {
							for (; i > n; n++) 1 === (e = this[n] || {}).nodeType && (ht.cleanData(f(e, !1)), e.innerHTML = t);
							e = 0
						} catch (t) {}
					}
			...
			ht.fn[t] = function(t) {
				for (var n, i = 0, o = [], r = ht(t), s = r.length - 1; s >= i; i++) n = i === s ? this : this.clone(!0), ht(r[i])[e](n), rt.apply(o, n.get());
		...
		t.getComputedStyle ? (de = function(e) {
			...
			var i,
				...
				s,
				a = t.style;
			return n = n || de(t), "" !== (s = n ? n.getPropertyValue(e) || n[e] : void 0) && void 0 !== s || ht.contains(t.ownerDocument, t) || (s = ht.style(t, e)), n && !ut.pixelMarginRight() && le.test(s) && ae.test(e) && (i = a.width, o = a.minWidth, r = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = o, a.maxWidth = r), void 0 === s ? s : s + ""
			...
			var i,
				...
				s,
				a = t.style;
			return n = n || de(t), null == (s = n ? n[e] : void 0) && a && a[e] && (s = a[e]), le.test(s) && !pe.test(e) && (i = a.left, o = t.runtimeStyle, (r = o && o.left) && (o.left = t.currentStyle.left), a.left = "fontSize" === e ? "1em" : s, s = a.pixelLeft + "px", a.left = i, r && (o.left = r)), void 0 === s ? s : s + "" || "auto"
		});
		var fe = /alpha\([^)]*\)/i,
			ge = /opacity\s*=\s*([^)]*)/i,
			me = /^(none|table(?!-c[ea]).+)/,
		...
		ht.extend({
			...
			style : function(t, e, n, i) {
				if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
					var o,
						...
						a = ht.camelCase(e),
						l = t.style;
					if (e = ht.cssProps[a] || (ht.cssProps[a] = O(a) || a), s = ht.cssHooks[e] || ht.cssHooks[a], void 0 === n) return s && "get" in s && void 0 !== (o = s.get(t, !1, i)) ? o : l[e];
					if ("string" === (r = typeof n) && (o = Pt.exec(n)) && o[1] && (n = h(t, e, o), r = "number"), null != n && n === n && ("number" === r && (n += o && o[3] || (ht.cssNumber[a] ? "" : "px")), ut.clearCloneStyle || "" !== n || 0 !== e.indexOf("background") || (l[e] = "inherit"), !(s && "set" in s && void 0 === (n = s.set(t, n, i))))) try {
							l[e] = n
						} catch (t) {}
				}
			},
			css : function(t, e, n, i) {
				var o,
					...
					s,
					a = ht.camelCase(e);
				return e = ht.cssProps[a] || (ht.cssProps[a] = O(a) || a), (s = ht.cssHooks[e] || ht.cssHooks[a]) && "get" in s && (r = s.get(t, !0, n)), void 0 === r && (r = he(t, e, i)), "normal" === r && e in we && (r = we[e]), "" === n || n ? (o = parseFloat(r), !0 === n || isFinite(o) ? o || 0 : r) : r
			}
		}), ht.each([ "height", "width" ], function(t, e) {
			ht.cssHooks[e] = {
				get : function(t, n, i) {
					return n ? me.test(ht.css(t, "display")) && 0 === t.offsetWidth ? ce(t, ye, function() {
						return M(t, e, i)
					}) : M(t, e, i) : void 0
				},
				set : function(t, n, i) {
					var o = i && de(t);
					return P(0, n, i ? L(t, e, i, ut.boxSizing && "border-box" === ht.css(t, "boxSizing", !1, o), o) : 0)
				}
			}
			...
			set : function(t, e) {
				...
				n.zoom = 1, (e >= 1 || "" === e) && "" === ht.trim(r.replace(fe, "")) && n.removeAttribute && (n.removeAttribute("filter"), "" === e || i && !i.filter) || (n.filter = fe.test(r) ? r.replace(fe, o) : r + " " + o)
			}
			...
			}, ae.test(t) || (ht.cssHooks[t + e].set = P)
		}), ht.fn.extend({
			css : function(t, e) {
				return jt(this, function(t, e, n) {
					var i,
						...
						s = 0;
					if (ht.isArray(e)) {
						for (i = de(t), o = e.length; o > s; s++) r[e[s]] = ht.css(t, e[s], !1, i);
						return r
					}
			...
			run : function(t) {
				...
				return this.options.duration ? this.pos = e = ht.easing[this.easing](t, this.options.duration * t, 0, 1, this.options.duration) : this.pos = e = t, this.now = (this.end - this.start) * e + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), n && n.set ? n.set(this) : j.propHooks._default.set(this), this
			}
		...
		ht.Animation = ht.extend(q, {
			...
			tweener : function(t, e) {
				...
				for (var n, i = 0, o = t.length; o > i; i++) n = t[i], q.tweeners[n] = q.tweeners[n] || [], q.tweeners[n].unshift(e)
			},
			prefilters : [ function(t, e, n) {
				var i,
					...
					p = t.nodeType && Mt(t),
					f = ht._data(t, "fxshow");
				n.queue || (null == (a = ht._queueHooks(t, "fx")).unqueued && (a.unqueued = 0, l = a.empty.fire, a.empty.fire = function() {
					a.unqueued || l()
				}), a.unqueued++, u.always(function() {
					u.always(function() {
						a.unqueued--, ht.queue(t, "fx").length || a.empty.fire()
					})
				})), 1 === t.nodeType && ("height" in e || "width" in e) && (n.overflow = [ h.overflow, h.overflowX, h.overflowY ], "inline" === ("none" === (c = ht.css(t, "display")) ? ht._data(t, "olddisplay") || A(t.nodeName) : c) && "none" === ht.css(t, "float") && (ut.inlineBlockNeedsLayout && "inline" !== A(t.nodeName) ? h.zoom = 1 : h.display = "inline-block")), n.overflow && (h.overflow = "hidden", ut.shrinkWrapBlocks() || u.always(function() {
				...
				for (i in e)
					if (o = e[i], Se.exec(o)) {
						...
						c = void 0;
				if (ht.isEmptyObject(d)) "inline" === ("none" === c ? A(t.nodeName) : c) && (h.display = c);else {
					...
					for (i in d) s = W(p ? f[i] : 0, i, u), i in f || (f[i] = s.start, p && (s.end = s.start, s.start = "width" === i || "height" === i ? 1 : 0))
				}
			} ],
			...
			var t,
				e = ht.timers,
				n = 0;
			for (Ce = ht.now(); n < e.length; n++) (t = e[n])() || e[n] !== t || e.splice(n--, 1);
		...
		ht.fn.extend({
			val : function(t) {
				...
				})) : o ? (e = ht.valHooks[o.type] || ht.valHooks[o.nodeName.toLowerCase()]) && "get" in e && void 0 !== (n = e.get(o, "value")) ? n : "string" == typeof (n = o.value) ? n.replace(Ee, "") : null == n ? "" : n : void 0
			}
		}), ht.extend({
			valHooks : {
				option : {
				...
				select : {
					get : function(t) {
						for (var e, n, i = t.options, o = t.selectedIndex, r = "select-one" === t.type || 0 > o, s = r ? null : [], a = r ? o + 1 : i.length, l = 0 > o ? a : r ? o : 0; a > l; l++)
							if (((n = i[l]).selected || l === o) && (ut.optDisabled ? !n.disabled : null === n.getAttribute("disabled")) && (!n.parentNode.disabled || !ht.nodeName(n.parentNode, "optgroup"))) {
		...
		ht.fn.extend({
			...
			attr : function(t, e, n) {
				var i,
					o,
					r = t.nodeType;
				if (3 !== r && 8 !== r && 2 !== r) return void 0 === t.getAttribute ? ht.prop(t, e, n) : (1 === r && ht.isXMLDoc(t) || (e = e.toLowerCase(), o = ht.attrHooks[e] || (ht.expr.match.bool.test(e) ? Ne : $e)), void 0 !== n ? null === n ? void ht.removeAttr(t, e) : o && "set" in o && void 0 !== (i = o.set(t, n, e)) ? i : (t.setAttribute(e, n + ""), n) : o && "get" in o && null !== (i = o.get(t, e)) ? i : null == (i = ht.find.attr(t, e)) ? void 0 : i)
			},
			attrHooks : {
				type : {
					set : function(t, e) {
			...
			removeAttr : function(t, e) {
				var n,
					...
					r = e && e.match(kt);
				if (r && 1 === t.nodeType)
					for (; n = r[o++];) i = ht.propFix[n] || n, ht.expr.match.bool.test(n) ? De && Oe || !Ie.test(n) ? t[i] = !1 : t[ht.camelCase("default-" + n)] = t[i] = !1 : ht.attr(t, n, ""), t.removeAttribute(Oe ? n : i)
			}
		}), Ne = {
			set : function(t, e, n) {
				return !1 === e ? ht.removeAttr(t, n) : De && Oe || !Ie.test(n) ? t.setAttribute(!Oe && ht.propFix[n] || n, n) : t[ht.camelCase("default-" + n)] = t[n] = !0, n
			}
		}, ht.each(ht.expr.match.bool.source.match(/\w+/g), function(t, e) {
			var n = Ae[e] || ht.find.attr;
			De && Oe || !Ie.test(e) ? Ae[e] = function(t, e, i) {
				var o,
					r;
		...
		ht.fn.extend({
			addClass : function(t) {
				...
				if (ht.isFunction(t)) return this.each(function(e) {
						ht(this).addClass(t.call(this, e, F(this)))
					});
				if ("string" == typeof t && t)
					for (e = t.match(kt) || []; n = this[l++];)
						if (o = F(n), i = 1 === n.nodeType && (" " + o + " ").replace(Me, " ")) {
			...
			removeClass : function(t) {
				var e,
					...
					l = 0;
				if (ht.isFunction(t)) return this.each(function(e) {
						ht(this).removeClass(t.call(this, e, F(this)))
					});
			...
			toggleClass : function(t, e) {
				...
				return "boolean" == typeof e && "string" === n ? e ? this.addClass(t) : this.removeClass(t) : ht.isFunction(t) ? this.each(function(n) {
					ht(this).toggleClass(t.call(this, n, F(this), e), e)
				}) : this.each(function() {
					var e,
						i,
						o,
						r;
					if ("string" === n)
						for (i = 0, o = ht(this), r = t.match(kt) || []; e = r[i++];) o.hasClass(e) ? o.removeClass(e) : o.addClass(e);
					else void 0 !== t && "boolean" !== n || ((e = F(this)) && ht._data(this, "__className__", e), ht.attr(this, "class", e || !1 === t ? "" : ht._data(this, "__className__") || ""))
				})
			},
			hasClass : function(t) {
				var e,
					...
					i = 0;
				for (e = " " + t + " "; n = this[i++];)
					if (1 === n.nodeType && (" " + F(n) + " ").replace(Me, " ").indexOf(e) > -1) return !0;
				return !1
			}
			...
			ajax : function(e, n) {
				function i(e, n, i, o) {
					var r,
						...
						x,
						T = n;
					2 !== b && (b = 2, l && t.clearTimeout(l), u = void 0, a = o || "", C.readyState = e > 0 ? 4 : 0, r = e >= 200 && 300 > e || 304 === e, i && (w = Q(h, C, i)), w = V(h, w, C, r), r ? (h.ifModified && ((x = C.getResponseHeader("Last-Modified")) && (ht.lastModified[s] = x), (x = C.getResponseHeader("etag")) && (ht.etag[s] = x)), 204 === e || "HEAD" === h.type ? T = "nocontent" : 304 === e ? T = "notmodified" : (T = w.state, d = w.data, y = w.error, r = !y)) : (y = T, !e && T || (T = "error", 0 > e && (e = 0))), C.status = e, C.statusText = (n || T) + "", r ? g.resolveWith(p, [ d, T, C ]) : g.rejectWith(p, [ C, T, y ]), C.statusCode(v), v = void 0, c && f.trigger(r ? "ajaxSuccess" : "ajaxError", [ C, h, r ? d : y ]), m.fireWith(p, [ C, T ]), c && (f.trigger("ajaxComplete", [ C, h ]), --ht.active || ht.event.trigger("ajaxStop")))
				}
				...
				var o,
					...
					C = {
						...
						getResponseHeader : function(t) {
							...
							if (2 === b) {
								if (!d)
									for (d = {}; e = Fe.exec(a);) d[e[1].toLowerCase()] = e[2];
								e = d[t.toLowerCase()]
							}
				...
				if (g.promise(C).complete = m.add, C.success = C.done, C.error = C.fail, h.url = ((e || h.url || Ze) + "").replace(Re, "").replace(Xe, Ke[1] + "//"), h.type = n.method || n.type || h.method || h.type, h.dataTypes = ht.trim(h.dataType || "*").toLowerCase().match(kt) || [ "" ], null == h.crossDomain && (o = Qe.exec(h.url.toLowerCase()), h.crossDomain = !(!o || o[1] === Ke[1] && o[2] === Ke[2] && (o[3] || ("http:" === o[1] ? "80" : "443")) === (Ke[3] || ("http:" === Ke[1] ? "80" : "443")))), h.data && h.processData && "string" != typeof h.data && (h.data = ht.param(h.data, h.traditional)), U(Ve, h, n, C), 2 === b) return C;
				(c = ht.event && h.global) && 0 == ht.active++ && ht.event.trigger("ajaxStart"), h.type = h.type.toUpperCase(), h.hasContent = !Ue.test(h.type), s = h.url, h.hasContent || (h.data && (s = h.url += (He.test(s) ? "&" : "?") + h.data,
				delete h.data
				), !1 === h.cache && (h.url = qe.test(s) ? s.replace(qe, "$1_=" + ze++) : s + (He.test(s) ? "&" : "?") + "_=" + ze++)), h.ifModified && (ht.lastModified[s] && C.setRequestHeader("If-Modified-Since", ht.lastModified[s]), ht.etag[s] && C.setRequestHeader("If-None-Match", ht.etag[s])), (h.data && h.hasContent && !1 !== h.contentType || n.contentType) && C.setRequestHeader("Content-Type", h.contentType), C.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + Ge + "; q=0.01" : "") : h.accepts["*"]);
		...
		ht.param = function(t, e) {
			...
			serializeArray : function() {
				return this.map(function() {
					...
					var t = this.type;
					return this.name && !ht(this).is(":disabled") && on.test(this.nodeName) && !nn.test(t) && (this.checked || !zt.test(t))
				}).map(function(t, e) {
					var n = ht(this).val();
			...
			return this.isLocal ? J() : nt.documentMode > 8 ? K() : /^(get|post|head|put|delete|options)$/i.test(this.type) && K() || J()
		} : K;
		var rn = 0,
			sn = {},
			an = ht.ajaxSettings.xhr();
		t.attachEvent && t.attachEvent("onunload", function() {
			for (var t in sn) sn[t](void 0, !0)
		}), ut.cors = !!an && "withCredentials" in an, (an = ut.ajax = !!an) && ht.ajaxTransport(function(e) {
					...
					send : function(i, o) {
						...
						s.send(e.hasContent && e.data || null), n = function(t, i) {
							...
							if (n && (i || 4 === s.readyState))
								if (
									delete sn[a]
									, n = void 0, s.onreadystatechange = ht.noop, i) 4 !== s.readyState && s.abort();else {
									c = {}, r = s.status, "string" == typeof s.responseText && (c.text = s.responseText);try {
										l = s.statusText
									} catch (t) {
										l = ""
									}
						...
						}, e.async ? 4 === s.readyState ? t.setTimeout(n) : s.onreadystatechange = sn[a] = n : n()
					},
					abort : function() {
						n && n(void 0, !0)
					}
			...
			if (t.crossDomain) {
				var e,
					n = nt.head || ht("head")[0] || nt.documentElement;
				return {
					send : function(i, o) {
		...
		ht.ajaxSetup({
			...
			return a || "jsonp" === e.dataTypes[0] ? (o = e.jsonpCallback = ht.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(cn, "$1" + o) : !1 !== e.jsonp && (e.url += (He.test(e.url) ? "&" : "?") + e.jsonp + "=" + o), e.converters["script json"] = function() {
				return s || ht.error(o + " was not called"), s[0]
			}, e.dataTypes[0] = "json", r = t[o], t[o] = function() {
				s = arguments
			}, i.always(function() {
				void 0 === r ? ht(t).removeProp(o) : t[o] = r, e[o] && (e.jsonpCallback = n.jsonpCallback, ln.push(o)), s && ht.isFunction(r) && r(s[0]), s = r = void 0
			}), "script") : void 0
		...
		ht.fn.load = function(t, e, n) {
			...
			offset : function(t) {
				...
				var e,
					...
					o = this[0],
					r = o && o.ownerDocument;
				return r ? (e = r.documentElement, ht.contains(e, o) ? (void 0 !== o.getBoundingClientRect && (i = o.getBoundingClientRect()), n = tt(r), {
			...
			ht.cssHooks[e] = I(ut.pixelPosition, function(t, n) {
				return n ? (n = he(t, e), le.test(n) ? ht(t).position()[e] + "px" : n) : void 0
			})
		}), ht.each({
			Height : "height",
			Width : "width"
		...
		return ht.noConflict = function(e) {
				return t.$ === ht && (t.$ = hn), e && t.jQuery === ht && (t.jQuery = dn), ht
			}, e || (t.jQuery = t.$ = ht), ht
		...
		o.prototype = {
			...
			_findParticles : function() {
				...
				this.particles = [], this.options.parallaxElements && this.$element.find("[data-stellar-ratio]").each(function() {
					...
					}), n = h.data("stellar-horizontal-offset") !== i ? h.data("stellar-horizontal-offset") : c !== i && c.data("stellar-horizontal-offset") !== i ? c.data("stellar-horizontal-offset") : e.horizontalOffset, o = h.data("stellar-vertical-offset") !== i ? h.data("stellar-vertical-offset") : c !== i && c.data("stellar-vertical-offset") !== i ? c.data("stellar-vertical-offset") : e.verticalOffset, e.particles.push({
						$element : h,
						$offsetParent : c,
			...
			_findBackgrounds : function() {
				...
				this.backgrounds = [], this.options.parallaxBackgrounds && (e = this.$element.find("[data-stellar-background-ratio]"), this.$element.data("stellar-background-ratio") && (e = e.add(this.$element)), e.each(function() {
					...
					}), e = f.data("stellar-horizontal-offset") !== i ? f.data("stellar-horizontal-offset") : p !== i && p.data("stellar-horizontal-offset") !== i ? p.data("stellar-horizontal-offset") : n.horizontalOffset, s = f.data("stellar-vertical-offset") !== i ? f.data("stellar-vertical-offset") : p !== i && p.data("stellar-vertical-offset") !== i ? p.data("stellar-vertical-offset") : n.verticalOffset, n.backgrounds.push({
						$element : f,
						$offsetParent : p,
			...
			t.data(n, "flexslider", o), m = {
					...
					setupPaging : function() {
						...
						if (o.controlNavScaffold = t('<ol class="' + s + "control-nav " + s + i + '"></ol>'), o.pagingCount > 1)
							for (var a = 0; a < o.pagingCount; a++) {
								if (void 0 === (n = o.slides.eq(a)).attr("data-thumb-alt") && n.attr("data-thumb-alt", ""), altText = "" !== n.attr("data-thumb-alt") ? altText = ' alt="' + n.attr("data-thumb-alt") + '"' : "", e = "thumbnails" === o.vars.controlNav ? '<img src="' + n.attr("data-thumb") + '"' + altText + "/>" : '<a href="#">' + r + "</a>", "thumbnails" === o.vars.controlNav && !0 === o.vars.thumbCaptions) {
				...
				directionNav : {
					setup : function() {
						...
						o.customDirectionNav ? o.directionNav = o.customDirectionNav : o.controlsContainer ? (t(o.controlsContainer).append(e), o.directionNav = t("." + s + "direction-nav li a", o.controlsContainer)) : (o.append(e), o.directionNav = t("." + s + "direction-nav li a", o)), m.directionNav.update(), o.directionNav.bind(c, function(e) {
							e.preventDefault();
							var n;
							("" === u || u === e.type) && (n = t(this).hasClass(s + "next") ? o.getTarget("next") : o.getTarget("prev"), o.flexAnimate(n, o.vars.pauseOnAction)), "" === u && (u = e.type), m.setToClearWatchedEvent()
						})
					},
					update : function() {
						var t = s + "disabled";
				...
				touch : function() {
					...
					a ? (n.style.msTouchAction = "none", n._gesture = new MSGesture, n._gesture.target = n, n.addEventListener("MSPointerDown", function(t) {
						t.stopPropagation(), o.animating ? t.preventDefault() : (o.pause(), n._gesture.addPointer(t.pointerId), w = 0, r = d ? o.h : o.w, l = Number(new Date), i = p && h && o.animatingTo === o.last ? 0 : p && h ? o.limit - (o.itemW + o.vars.itemMargin) * o.move * o.animatingTo : p && o.currentSlide === o.last ? o.limit : p ? (o.itemW + o.vars.itemMargin) * o.move * o.currentSlide : h ? (o.last - o.currentSlide + o.cloneOffset) * r : (o.currentSlide + o.cloneOffset) * r)
						...
						if (e) {
							...
							return w += d ? a : o, s = w, m = d ? Math.abs(w) < Math.abs(-o) : Math.abs(w) < Math.abs(-a), t.detail === t.MSGESTURE_FLAG_INERTIA ? void setImmediate(function() {
									n._gesture.stop()
								}) : void ((!m || Number(new Date) - l > 500) && (t.preventDefault(), !f && e.transitions && (e.vars.animationLoop || (s = w / (0 === e.currentSlide && 0 > w || e.currentSlide === e.last && w > 0 ? Math.abs(w) / r + 2 : 1)), e.setProps(i + s, "setTouch"))))
						}
						...
						v = n.touches[0].pageX, y = n.touches[0].pageY, s = d ? t - y : t - v;(!(m = d ? Math.abs(s) < Math.abs(v - e) : Math.abs(s) < Math.abs(y - e)) || Number(new Date) - l > 500) && (n.preventDefault(), !f && o.transitions && (o.vars.animationLoop || (s /= 0 === o.currentSlide && 0 > s || o.currentSlide === o.last && s > 0 ? Math.abs(s) / r + 2 : 1), o.setProps(i + s, "setTouch")))
					}, g = function(a) {
				...
				if (o.vars.animationLoop || e === o.currentSlide || (o.direction = e > o.currentSlide ? "next" : "prev"), g && 1 === o.pagingCount && (o.direction = o.currentItem < e ? "next" : "prev"), !o.animating && (o.canAdvance(e, a) || i) && o.is(":visible")) {
					...
					if (o.animating = !0, o.animatingTo = e, n && o.pause(), o.vars.before(o), o.syncExists && !a && m.sync("animate"), o.vars.controlNav && m.controlNav.active(), p || o.slides.removeClass(s + "active-slide").eq(e).addClass(s + "active-slide"), o.atEnd = 0 === e || e === o.last, o.vars.directionNav && m.directionNav.update(), e === o.last && (o.vars.end(o), o.vars.animationLoop || o.pause()), f)
						...
						var u,
							v,
							y,
							w = d ? o.slides.filter(":first").height() : o.computedW;
				...
				var i = function() {
					...
					return -1 * function() {
							if (p) return "setTouch" === e ? t : h && o.animatingTo === o.last ? 0 : h ? o.limit - (o.itemW + o.vars.itemMargin) * o.move * o.animatingTo : o.animatingTo === o.last ? o.limit : n;
							switch (e) {
							case "setTotal":
								return h ? (o.count - 1 - o.currentSlide + o.cloneOffset) * t : (o.currentSlide + o.cloneOffset) * t;case "setTouch":
								return t;case "jumpEnd":
								return h ? t : o.count * t;case "jumpStart":
								return h ? o.count * t : t;default:
								return t
							}
						}() + "px"
				}();
				...
				if (f) o.slides.css({
					...
					"init" === e && (o.viewport = t('<div class="' + s + 'viewport"></div>').css({
						overflow : "hidden",
						position : "relative"
					}).appendTo(o).append(o.container), o.cloneCount = 0, o.cloneOffset = 0, h && (i = t.makeArray(o.slides).reverse(), o.slides = t(i), o.container.empty().append(o.slides))), o.vars.animationLoop && !p && (o.cloneCount = 2, o.cloneOffset = 1, "init" !== e && o.container.find(".clone").remove(), o.container.append(m.uniqueID(o.slides.first().clone().addClass("clone")).attr("aria-hidden", "true")).prepend(m.uniqueID(o.slides.last().clone().addClass("clone")).attr("aria-hidden", "true"))), o.newSlides = t(o.vars.selector, o), n = h ? o.count - 1 - o.currentSlide + o.cloneOffset : o.currentSlide + o.cloneOffset, d && !p ? (o.container.height(200 * (o.count + o.cloneCount) + "%").css("position", "absolute").width("100%"), setTimeout(function() {
						o.newSlides.css({
							display : "block"
				...
				var t = o.slides.first(),
					...
					n = o.vars.minItems,
					i = o.vars.maxItems;
				o.w = void 0 === o.viewport ? o.width() : o.viewport.width(), o.h = t.height(), o.boxPadding = t.outerWidth() - t.width(), p ? (o.itemT = o.vars.itemWidth + e, o.itemM = e, o.minW = n ? n * o.itemT : o.w, o.maxW = i ? i * o.itemT - e : o.w, o.itemW = o.minW > o.w ? (o.w - e * (n - 1)) / n : o.maxW < o.w ? (o.w - e * (i - 1)) / i : o.vars.itemWidth > o.w ? o.w : o.vars.itemWidth, o.visible = Math.floor(o.w / o.itemW), o.move = o.vars.move > 0 && o.vars.move < o.visible ? o.vars.move : o.visible, o.pagingCount = Math.ceil((o.count - o.visible) / o.move + 1), o.last = o.pagingCount - 1, o.limit = 1 === o.pagingCount ? 0 : o.vars.itemWidth > o.w ? o.itemW * (o.count - 1) + e * (o.count - 1) : (o.itemW + e) * o.count - o.w - e) : (o.itemW = o.w, o.itemM = e, o.pagingCount = o.count, o.last = o.count - 1), o.computedW = o.itemW - o.boxPadding, o.computedM = o.itemM
		...
		var e = function(n, i) {
			this.$element = t(n), this.options = t.extend({}, e.DEFAULTS, this.dataOptions(), i), this.init()
		};
		e.DEFAULTS = {
			from : 0,
			to : 0,
			...
			return this.each(function() {
				...
				r && (o && o.stop(), i.data("countTo", o = new e(this, s))), o[a].call(o)
			})
		}
	}), function(t) {
		function e(e) {
		...
		t.expr[":"].appeared = function(e) {
			...
			appear : function(e) {
				...
				return o.force_process && setTimeout(n, o.interval), i(l), t(l)
			}
		}), t.extend({
		...
		y.prototype = {
			...
			open : function(n) {
				...
				} else e.items = t.isArray(n.items) ? n.items : [ n.items ], e.index = n.index || 0;
				{
					if (!e.isOpen) {
						...
						T("BeforeOpen"), e.st.showCloseBtn && (e.st.closeBtnInside ? (x(u, function(t, e, n, i) {
						...
						return e.isIE7 && (y += " mfp-ie7"), y && e._addClassToMFP(y), e.updateItemHTML(), T("BuildControls"), t("html").css(m), e.bgOverlay.add(e.wrap).prependTo(e.st.prependTo || i), e._lastFocusedEl = document.activeElement, setTimeout(function() {
								e.content ? (e._addClassToMFP(g), e._setFocus()) : e.bgOverlay.addClass(g), o.on("focusin" + f, e._onFocusIn)
							}, 16), e.isOpen = !0, e.updateSize(p), T(d), n
					}
					e.updateItemHTML()
				}
			},
			...
			updateItemHTML : function() {
				...
				e.appendContent(s, i), n.preloaded = !0, T(h, n), r = n.type, e.container.prepend(e.contentContainer), T("AfterChange")
			},
			appendContent : function(t, n) {
				e.content = t, t ? e.st.showCloseBtn && e.st.closeBtnInside && !0 === e.currTemplate[n] ? e.content.find(".mfp-close").length || e.content.append(S()) : e.content = t : e.content = "", T("BeforeAppend"), e.container.addClass("mfp-" + n + "-holder"), e.contentContainer.append(e.content)
			},
			parseEl : function(n) {
				var i,
					o = e.items[n];
		...
		t.magnificPopup.registerModule(D, {
			...
			proto : {
				initAjax : function() {
					e.types.push(D), O = e.st.ajax.cursor, x(l + "." + D, L), x("BeforeChange." + D, L)
				},
				getAjax : function(n) {
					...
					var o = t.extend({
						...
						success : function(i, o, r) {
							...
							T("ParseAjax", s), e.appendContent(t(s.data), D), n.finished = !0, P(), e._setFocus(), setTimeout(function() {
								e.wrap.addClass(g)
							}, 16), e.updateStatus("ready"), T("AjaxContentAdded")
						},
						error : function() {
							P(), n.finished = n.loadError = !0, e.updateStatus("error", e.st.ajax.tError.replace("%url%", n.src))
						}
					}, e.st.ajax.settings);
			...
			proto : {
				initImage : function() {
					...
					e.types.push("image"), x(d + n, function() {
						...
						t.cursor && i.removeClass(t.cursor), b.off("resize" + f)
				...
				getImage : function(n, i) {
					var o = 0,
						r = function() {
							n && (n.img[0].complete ? (n.img.off(".mfploader"), n === e.currItem && (e._onImageHasSize(n), e.updateStatus("ready")), n.hasSize = !0, n.loaded = !0, T("ImageLoadComplete")) : 200 > ++o ? setTimeout(r, 100) : s())
						},
						s = function() {
					...
					if (l.length) {
						...
						c.className = "mfp-img", n.img = t(c).on("load.mfploader", r).on("error.mfploader", s), c.src = n.src, l.is("img") && (n.img = n.img.clone()), (c = n.img[0]).naturalWidth > 0 ? n.hasSize = !0 : c.width || (n.hasSize = !1)
					}
		...
		t.magnificPopup.registerModule(W, {
			...
			proto : {
				initIframe : function() {
					e.types.push(W), x("BeforeChange", function(t, e, n) {
						e !== n && (e === W ? R() : n === W && R(!0))
					}), x(l + "." + W, function() {
						R()
					})
		...
		t.magnificPopup.registerModule("gallery", {
			...
			proto : {
				...
				preloadNearbyImages : function() {
					...
					for (t = 1; (e.direction ? i : o) >= t; t++) e._preloadItem(e.index - t)
				},
				...
				return t(this).each(function() {
					...
					if (e) {
						...
						s.on("touchstart" + i, function(t) {
							u = !1, h = 1, d = t.originalEvent ? t.originalEvent.touches[0] : t.touches[0], l = d.clientX, c = d.clientY, b.on("touchmove" + i, function(t) {
								...
								n(), u || h > 1 || (r = !0, t.preventDefault(), clearTimeout(a), a = setTimeout(function() {
									r = !1
								}, 1e3), o())
							})
						})
	...
	}(window.jQuery || window.Zepto), function(t, e, n, i) {
		function o(e, n) {
		...
		h = {
			...
			run : function() {
				var t,
					...
					a = s + this.width() * o,
					l = [];
				for (n = 0, i = this._coordinates.length; i > n; n++) t = this._coordinates[n - 1] || 0, e = Math.abs(this._coordinates[n]) + r * o, (this.op(t, "<=", s) && this.op(t, ">", a) || this.op(e, "<", s) && this.op(e, ">", a)) && l.push(n);
			...
			delete o.responsive
			, o.responsiveClass && this.$element.attr("class", function(t, e) {
			...
			return this.settings.freeDrag || t.each(o, t.proxy(function(t, r) {
					return e > r - 30 && r + 30 > e ? n = t : this.op(e, "<", r) && this.op(e, ">", o[t + 1] || r - i) && (n = "left" === this.state.direction ? t + 1 : t), -1 === n
			...
			if (!r.loop && r.center)
				...
				if (r.loop || r.center)
					e = this._items.length + r.items;else {
			...
			switch (e) {
			case "<":
				return i ? t > n : n > t;case ">":
				return i ? n > t : t > n;case ">=":
				return i ? n >= t : t >= n;case "<=":
				return i ? t >= n : n >= t
			}
		...
		i.Defaults = {
			...
			if ((i = s.match(/(http:|https:|)\/\/(player.|www.)?(vimeo\.com|youtu(be\.com|\.be|be\.googleapis\.com))\/(video\/|embed\/|watch\?v=|v\/)?([A-Za-z0-9._%-]*)(\&\S+)?/))[3].indexOf("youtu") > -1)
				n = "youtube";else {
			...
			return e.wrap('<div class="owl-video-wrapper"' + s + "></div>"), this._core.settings.lazyLoad && (l = "data-src", c = "owl-lazy"), a.length ? (d(a.attr(l)), a.remove(), !1) : void ("youtube" === n.type ? (r = "http://img.youtube.com/vi/" + n.id + "/hqdefault.jpg", d(r)) : "vimeo" === n.type && t.ajax({
					type : "GET",
		...
		e.Defaults = {
			...
			if ("page" !== n.slideBy && (n.slideBy = Math.min(n.slideBy, n.items)), n.dots || "page" == n.slideBy)
				for (this._pages = [], t = i, e = 0, 0; o > t; t++) (e >= r || 0 === e) && (this._pages.push({
						start : t - i,
						end : t - i + r - 1
	...
	}(window.Zepto || window.jQuery, window, document), "undefined" == typeof jQuery)
...
+function(t) {
	...
	function e(e) {
		...
		n || (n = e.attr("href"), n = n && /#[A-Za-z]/.test(n) && n.replace(/.*(?=#[^\s]*$)/, ""));var i = n && t(n);
